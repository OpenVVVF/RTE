...
RuntimeTab::RuntimeTab(RuntimeController* controller, QWidget* parent)
    ...
    // one line, with the reject breakdown moved into the health tooltip. The
    // row also carries pause/speed controls and a full-session export that is
    // independent of the rolling plot buffers.
