/*
 * main.h — SIL replacement for the CubeMX-generated main.h.
 *
 * Pin map copied 1:1 from Images/Gen6FW/Inc/main.h so firmware code sees the
 * same macro names; GPIO "ports" are SIL model endpoints (stm32h7xx_hal.h).
 */
#ifndef SIL_MAIN_H
#define SIL_MAIN_H
