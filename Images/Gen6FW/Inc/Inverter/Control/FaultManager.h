...
enum class FaultSource : uint32_t {
    ...
    TempSensor       = 1u << 23,  /**< Temperature sensor open/short          */
    OvertemperatureMotor = 1u << 24,  /**< Motor temperature above limit    */
    OvertemperatureInverter = 1u << 25, /**< Board temperature above limit  */
};
