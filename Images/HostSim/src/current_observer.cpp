 ...
 * (Images/Gen6FW/Src/Inverter/Control/CurrentObserver.cpp).  See the header
 * for the porting contract; the step math below is byte-for-byte the Gen6
 * algorithm so graph behavior matches the STM32 images. */
