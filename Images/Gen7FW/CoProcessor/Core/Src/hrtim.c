...
void HAL_HRTIM_MspInit(HRTIM_HandleTypeDef* hrtimHandle)
{
  ...
  /* USER CODE END HRTIM1_MspInit 0 */
    ...
    PB10     ------> HRTIM1_FLT3
    */
    GPIO_InitStruct.Pin = TIMER_SYNC_FROM_MASTER_Pin|GATE_DRIVER_FAULT_IN_Pin;
...
void HAL_HRTIM_MspDeInit(HRTIM_HandleTypeDef* hrtimHandle)
{
  ...
  /* USER CODE END HRTIM1_MspDeInit 0 */
    ...
    PA9     ------> HRTIM1_CHA2
    */
    HAL_GPIO_DeInit(GPIOB, TIMER_SYNC_FROM_MASTER_Pin|GATE_DRIVER_FAULT_IN_Pin|PH_V_LOW_Pin|PH_V_HIGH_Pin
                          |PH_W_LOW_Pin|PH_W_HIGH_Pin);

    HAL_GPIO_DeInit(GPIOA, PH_U_LOW_Pin|PH_U_HIGH_Pin);
