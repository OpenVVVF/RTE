...
static void init()
{
    ...
    app::AppLoopInit(appState.app_loop);
    app::TimIsrInit(appState.tim_isr);
    app::AdcIsrInit(appState.adc_isr);
    app::VsenseInit(appState.vsense);
