...
void HAL_ADC_MspInit(ADC_HandleTypeDef* adcHandle)
{
  ...
  /* USER CODE END ADC2_MspInit 0 */
    ...
    */
    ...
    GPIO_InitStruct.Pin = AIN_HALL_W_Pin|AIN_THROTTLE_A_Pin|AIN_PH_V_CURSENS_Pin|AIN_PH_V_CURSENS_REF_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);
  ...
  /* USER CODE END ADC3_MspInit 0 */
    ...
    PC3_C     ------> ADC3_INP1
    */
    GPIO_InitStruct.Pin = AIN_MOTOR_TMP_Pin|AIN_THROTTLE_B_Pin|AIN_TMP_SENSE_1_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(GPIOF, &GPIO_InitStruct);
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* adcHandle)
{
  ...
  /* USER CODE END ADC2_MspDeInit 0 */
    ...
    */
    ...
    HAL_GPIO_DeInit(GPIOA, AIN_HALL_W_Pin|AIN_THROTTLE_A_Pin|AIN_PH_V_CURSENS_Pin|AIN_PH_V_CURSENS_REF_Pin);
  ...
  /* USER CODE END ADC3_MspDeInit 0 */
    ...
    PC3_C     ------> ADC3_INP1
    */
    HAL_GPIO_DeInit(GPIOF, AIN_MOTOR_TMP_Pin|AIN_THROTTLE_B_Pin|AIN_TMP_SENSE_1_Pin);
