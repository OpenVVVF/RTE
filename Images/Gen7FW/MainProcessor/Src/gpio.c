...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOD, COPROCESSOR_SYNC_Pin|COPROCESSOR_WAKEUP_Pin|COPROCESSOR_BOOTSEL_Pin
                          |SPI2_CS_Pin|GATE_DRIVER_RESET_Pin|POWERMON_ENABLE_Pin, GPIO_PIN_RESET);
  HAL_GPIO_WritePin(GPIOD, COPROCESSOR_RESET_Pin, GPIO_PIN_SET);
  ...
  /*Configure GPIO pins : COPROCESSOR_SYNC_Pin COPROCESSOR_WAKEUP_Pin COPROCESSOR_RESET_Pin COPROCESSOR_BOOTSEL_Pin
                           SPI2_CS_Pin GATE_DRIVER_RESET_Pin POWERMON_ENABLE_Pin */
  GPIO_InitStruct.Pin = COPROCESSOR_SYNC_Pin|COPROCESSOR_WAKEUP_Pin|COPROCESSOR_RESET_Pin|COPROCESSOR_BOOTSEL_Pin
                          |SPI2_CS_Pin|GATE_DRIVER_RESET_Pin|POWERMON_ENABLE_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  /*Configure GPIO pins : USER_DIN_6_Pin VSENSE_ISO_ADC_INTERRUPT_Pin GATE_DRIVE_PWR2_FEEDBACK_Pin GATE_DRIVE_PWR1_FEEDBACK_Pin
                           POWERMON_SLEEP_Pin */
  GPIO_InitStruct.Pin = USER_DIN_6_Pin|VSENSE_ISO_ADC_INTERRUPT_Pin|GATE_DRIVE_PWR2_FEEDBACK_Pin|GATE_DRIVE_PWR1_FEEDBACK_Pin
                          |POWERMON_SLEEP_Pin;
