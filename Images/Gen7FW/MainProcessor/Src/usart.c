...
void HAL_UART_MspInit(UART_HandleTypeDef* uartHandle)
{
  ...
  */
    ...
    PB9     ------> UART4_TX
    */
    GPIO_InitStruct.Pin = MULTIDRIVE_UART_RX_FIBER_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF8_UART4;
    HAL_GPIO_Init(MULTIDRIVE_UART_RX_FIBER_GPIO_Port, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = MULTIDRIVE_UART_TX_FIBER_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF8_UART4;
    HAL_GPIO_Init(MULTIDRIVE_UART_TX_FIBER_GPIO_Port, &GPIO_InitStruct);
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* uartHandle)
{
  ...
  /* USER CODE END UART4_MspDeInit 0 */
    ...
    PB9     ------> UART4_TX
    */
    HAL_GPIO_DeInit(MULTIDRIVE_UART_RX_FIBER_GPIO_Port, MULTIDRIVE_UART_RX_FIBER_Pin);

    HAL_GPIO_DeInit(MULTIDRIVE_UART_TX_FIBER_GPIO_Port, MULTIDRIVE_UART_TX_FIBER_Pin);
