...
void HAL_I2C_MspDeInit(I2C_HandleTypeDef* i2cHandle)
{
  ...
  /* USER CODE END I2C5_MspDeInit 0 */
    ...
    PF1     ------> I2C5_SCL
    */
    HAL_GPIO_DeInit(ONBOARD_TEMP_SENSE_I2C_SDA_GPIO_Port, ONBOARD_TEMP_SENSE_I2C_SDA_Pin);

    HAL_GPIO_DeInit(ONBOARD_TEMP_SENSE_I2C_SCL_GPIO_Port, ONBOARD_TEMP_SENSE_I2C_SCL_Pin);
