...
/* Gen7 new-feature pin labels (not initialized here) */
...
#define DEBUG_TRGIO_Pin GPIO_PIN_7
#define DEBUG_TRGIO_GPIO_Port GPIOC
#define UART9_RX_Pin GPIO_PIN_0
#define UART9_RX_GPIO_Port GPIOG
#define UART9_TX_Pin GPIO_PIN_1
#define UART9_TX_GPIO_Port GPIOG
