...
#define ONBOARD_TEMP_SENSE_I2C_SDA_Pin GPIO_PIN_0
#define ONBOARD_TEMP_SENSE_I2C_SDA_GPIO_Port GPIOF
#define ONBOARD_TEMP_SENSE_I2C_SCL_Pin GPIO_PIN_1
#define ONBOARD_TEMP_SENSE_I2C_SCL_GPIO_Port GPIOF
...
#define AIN_THROTTLE_B_Pin GPIO_PIN_6
#define AIN_THROTTLE_B_GPIO_Port GPIOF
#define AIN_TMP_SENSE_1_Pin GPIO_PIN_8
#define AIN_TMP_SENSE_1_GPIO_Port GPIOF
...
#define PHASE_CURRENT_COMPARIATOR_N_Pin GPIO_PIN_4
#define PHASE_CURRENT_COMPARIATOR_N_GPIO_Port GPIOA
#define DC_LINK_CURRENT_COMPARITOR_N_Pin GPIO_PIN_5
#define DC_LINK_CURRENT_COMPARITOR_N_GPIO_Port GPIOA
...
#define VOLTAGE_MONITOR_I2C_SDA_Pin GPIO_PIN_15
#define VOLTAGE_MONITOR_I2C_SDA_GPIO_Port GPIOF
#define MULTIDIRVE_FIBER_SYNC_LINE_Pin GPIO_PIN_7
#define MULTIDIRVE_FIBER_SYNC_LINE_GPIO_Port GPIOE
...
#define COPROCESSOR_SYNC_Pin GPIO_PIN_8
#define COPROCESSOR_SYNC_GPIO_Port GPIOD
#define COPROCESSOR_WAKEUP_Pin GPIO_PIN_9
#define COPROCESSOR_WAKEUP_GPIO_Port GPIOD
#define COPROCESSOR_RESET_Pin GPIO_PIN_10
#define COPROCESSOR_RESET_GPIO_Port GPIOD
#define COPROCESSOR_BOOTSEL_Pin GPIO_PIN_11
#define COPROCESSOR_BOOTSEL_GPIO_Port GPIOD
#define VOLTAGE_MONITOR_I2C_SCL_Pin GPIO_PIN_12
#define VOLTAGE_MONITOR_I2C_SCL_GPIO_Port GPIOD
...
#define COPROCESSOR_TIMER_SYNC_OUTPUT_Pin GPIO_PIN_6
#define COPROCESSOR_TIMER_SYNC_OUTPUT_GPIO_Port GPIOC
...
#define MULTIDRIVE_UART_RX_FIBER_Pin GPIO_PIN_0
#define MULTIDRIVE_UART_RX_FIBER_GPIO_Port GPIOD
...
#define GATE_DRIVE_PWR2_FEEDBACK_Pin GPIO_PIN_3
#define GATE_DRIVE_PWR2_FEEDBACK_GPIO_Port GPIOD
#define GATE_DRIVE_PWR1_FEEDBACK_Pin GPIO_PIN_4
#define GATE_DRIVE_PWR1_FEEDBACK_GPIO_Port GPIOD
#define GATE_DRIVER_RESET_Pin GPIO_PIN_5
#define GATE_DRIVER_RESET_GPIO_Port GPIOD
#define POWERMON_SLEEP_Pin GPIO_PIN_6
#define POWERMON_SLEEP_GPIO_Port GPIOD
#define POWERMON_ENABLE_Pin GPIO_PIN_7
#define POWERMON_ENABLE_GPIO_Port GPIOD
...
#define MULTIDRIVE_UART_TX_FIBER_Pin GPIO_PIN_9
#define MULTIDRIVE_UART_TX_FIBER_GPIO_Port GPIOB
